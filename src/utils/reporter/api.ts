...
export function reportApiRequest<T extends IResponseFields>
(requestOptions: IRequestOptions, response: IResponse<T>) {
...
export function logApiResponse<T extends IResponseFields>
(requestOptions: IRequestOptions, response: IResponse<T>) {
